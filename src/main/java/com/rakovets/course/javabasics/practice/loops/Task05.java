...
public class Task05 {
    public static void main(String[] args) {
        ...
        int hour = 0;
        double healthPoints1 = (double)healthPoints;
        double averageDamagePerHour1 = (double)averageDamagePerHour;
        while (healthPoints1 > 0) {
            healthPoints1 = healthPoints1 * (1 + regenerationPercentFromCurrentHealth / 100) - averageDamagePerHour1;
            hour++;
            if (hour > 24) {
                break;
            }
